...
<head>
    <meta charset="UTF-8">
    <title>Generate Datesheet - DSR</title>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-success">Generate Datesheet</button>
            </form>
        </div>
