...
// Get fee allocations with student details - ORDERED properly
$allocations = $pdo->query("
    SELECT fa.*, s.name, s.roll_no, c.class_name, fs.fee_name, 
...
<head>
    ...
    <style>
        * {
        ...
        body.dark-theme select, body.dark-theme input, body.dark-theme textarea { background: #0f0f23; border-color: var(--border); color: var(--text); }
        ...
        body.dark-theme td { border-color: var(--border); }
...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value"><?php echo $summary['total_students']; ?></div>
                <div>Total Students</div>
            </div>
            <div class="stat-card">
                <div class="stat-value" style="color: #28a745;">Rs <?php echo number_format($summary['collected']); ?></div>
                <div>Collected</div>
            </div>
            <div class="stat-card">
                <div class="stat-value" style="color: #ffc107;">Rs <?php echo number_format($summary['pending']); ?></div>
                <div>Pending</div>
            </div>
            <div class="stat-card">
                <div class="stat-value" style="color: #17a2b8;"><?php echo $summary['partial_count']; ?></div>
                <div>Partial Payments</div>
            </div>
        </div>
        
        <!-- Allocate Fees - Admin/Accountant Only -->
                    ...
                    <div class="form-group">
                        ...
                        <select name="fee_structure_id" required>
                            ...
                            <?php foreach($fee_structures as $fs): ?>
                                <option value="<?php echo $fs['id']; ?>"><?php echo $fs['fee_name']; ?> - Rs <?php echo number_format($fs['amount']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount_paid" step="0.01" id="payment_amount" required>
                </div>
                <div class="form-group">
