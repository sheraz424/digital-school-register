...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_student'])) {
    ...
    $monthly_fee = $_POST['monthly_fee'] ?? 5000;
    ...
    // Create fee allocation for the student
    $due_date = date('Y-m-d', strtotime('+15 days'));
    $stmt = $pdo->prepare("INSERT INTO fee_allocations (student_id, fee_structure_id, amount, due_date, status) VALUES (?, 1, ?, ?, 'Pending')");
    $stmt->execute([$student_id, $monthly_fee, $due_date]);
    ...
    $success = "Student added! Email: $student_email | Password: $default_password | Monthly Fee: Rs $monthly_fee";
}
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <input type="number" name="monthly_fee" placeholder="Monthly Fee (Rs)" value="5000" step="500">
                <div class="info-text">Fee will be auto-assigned with 15 days due date</div>
        ...
        function openEditModal(id) {
            fetch(`api/get_student.php?id=${id}`)
                ...
                .then(data => {
                    ...
                    } else { alert('Error loading student data: ' + (data.message || 'Unknown error')); }
